...
public class SCIMUserOperationListenerTest extends PowerMockTestCase {
    ...
    public void testDoPreUpdateCredential() throws Exception {
        assertTrue(scimUserOperationListener.doPreUpdateCredential(userName, credential, credential,
                userStoreManager));
    }
    ...
    public void testDoPreUpdateCredentialByAdmin() throws Exception {
        assertTrue(scimUserOperationListener.doPreUpdateCredentialByAdmin(userName, credential,
                userStoreManager));
    }
    ...
    public void testDoPostUpdateCredentialByAdmin(boolean isEnabled, boolean isSCIMEnabled)
        ...
        assertTrue(scimUserOperationListener.doPostUpdateCredentialByAdmin(userName, credential,
                userStoreManager));
    }
    ...
    public void testDoPreSetUserClaimValue() throws Exception {
        assertTrue(scimUserOperationListener.doPreSetUserClaimValue(eq(userName), anyString(), anyString(),
    ...
    @Test(dataProvider = "testDoPreAddUserData")
    public void testDoPreSetUserClaimValues(boolean isEnabled, boolean isSCIMEnabled)
            throws Exception {
        when(scimUserOperationListener.isEnable()).thenReturn(isEnabled);
        when(userStoreManager.isSCIMEnabled()).thenReturn(isSCIMEnabled);
    ...
    @Test(dataProvider = "testDoPostAddRoleData")
    public void testDoPreDeleteRole(boolean isEnabled, boolean isSCIMEnabled, boolean isGroupExisting, String domainName) throws Exception {
        when(scimUserOperationListener.isEnable()).thenReturn(isEnabled);
        when(userStoreManager.isSCIMEnabled()).thenReturn(isSCIMEnabled);
        when(groupDAO.isExistingGroup(anyString(), anyInt())).thenReturn(isGroupExisting);
        whenNew(GroupDAO.class).withNoArguments().thenReturn(groupDAO);
    ...
    public void testDoPreUpdateRoleListOfUser() throws Exception {
        assertTrue(scimUserOperationListener.doPreUpdateRoleListOfUser(anyString(), any(String[].class), any
                (String[].class), eq(userStoreManager)));
    }

    @Test
    public void testDoPostUpdateRoleListOfUser() throws Exception {
        assertTrue(scimUserOperationListener.doPostUpdateRoleListOfUser(anyString(), any(String[].class), any
                (String[].class), eq(userStoreManager)));
    }
